...
if __name__ == '__main__':
    ...
    # Model Parameters
    parser.add_argument('--input_features', type=int, default=5, metavar='IN',
                        help='Number of input nodes in the neural network (default: 5)')
    parser.add_argument('--hidden_dim', type=int, default=10, metavar='HD',
                        help='Number of hidden nodes in the neural network (default: 10)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='OUT',
                        help='Number of output nodes in the neural network (default: 1)')
